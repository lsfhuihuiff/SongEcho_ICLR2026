...
if __name__ == "__main__":
    ...
    parser.add_argument("--hop_length", type=int, default=256, help="Hop length for f0 extraction")
    parser.add_argument("--f0_min", type=int, default=50, help="Minimum f0 value")
    parser.add_argument("--f0_max", type=int, default=1100, help="Maximum f0 value")
    ...
    fpc = extract_fpc(
        ...
        f0_min=args.f0_min,
        f0_max=args.f0_max,
        kwargs={"fs": 16000, "method": "cut", "need_mean": False},
    )
    print(f"FPC: {fpc}")