...
class ACEStepTransformer2DModel(
    ...
    def encode(
        ...
        # print(self.speaker_embedder)
        if shield_spk:
            # speaker_embeds = torch.zeros_like(speaker_embeds)
            speaker_embeds = torch.zeros(bs, 512, device=device)
    ...
    def decode(
        ...
        for index_block, block in enumerate(self.transformer_blocks):
            if index_block > 24:
                ...
                tmp_cond = encoder_hidden_states_con
            if self.training and self.gradient_checkpointing:
                ...
                hidden_states = torch.utils.checkpoint.checkpoint(
                    ...
                    temb=temb,
                    use_reentrant=False,
                    encoder_hidden_states_con = tmp_cond,
